...
export default function Subjects() {
  ...
  const sendToVisionAPI = async (subject, topic, lessonData) => {
    try {
      ...
      console.log("🎬 Ngrok endpoint: https://4e6b01c6e6f2.ngrok-free.app/generate-video");
      ...
      try {
        ...
        try {
          ...
          try {
            ...
            const ngrokResponse = await fetch("https://213c998780ff.ngrok-free.app/generate-video", {
              method: 'POST',
              headers: {
                ...headers,
