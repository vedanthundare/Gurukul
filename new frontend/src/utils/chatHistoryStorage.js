...
// Welcome message variations for more natural conversation
const WELCOME_MESSAGES = [
  '🙏🏽 Namaste! I am UniGuru, your AI learning assistant. How can I help you learn today?',
  '✨ Welcome back! I\'m here to help you explore and learn. What would you like to discover today?',
  '📚 Hello! Ready to dive into some learning? I\'m here to guide you through any topic you\'re curious about.',
  '🌟 Greetings! I\'m UniGuru, your personal learning companion. What knowledge are you seeking today?',
  '🎓 Welcome! I\'m excited to help you learn something new. What subject interests you most right now?',
];

// Function to get a contextual welcome message
const getWelcomeMessage = (isReturningUser = false, lastSessionTime = null) => {
  let message;

  if (isReturningUser && lastSessionTime) {
    ...
    // First time or new session - use random welcome message
...
class ChatHistoryStorage {
  ...
  loadChatHistory() {
    ...
    try {
      ...
      if (sessionHistory && Array.isArray(sessionHistory.messages)) {
        ...
        const isReturningUser = validMessages.length > 1; // More than just welcome message
          ...
          if (isReturningUser && hasWelcomeMessage) {
            ...
            if (welcomeIndex !== -1) {
              ...
              if (welcomeAge > 60 * 60 * 1000) {
                const newWelcomeMessage = this.getContextualWelcomeMessage(true, lastSessionTime);
   ...
   */
  getContextualWelcomeMessage(isReturningUser = false, lastSessionTime = null) {
    return getWelcomeMessage(isReturningUser, lastSessionTime);
  }
