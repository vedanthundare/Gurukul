...
"""
        ...
        formatted_lesson = {
            ...
            "quiz": [
                ...
                {
                    "question": f"How does understanding {topic} benefit students of {subject}?",
                    "options": [
                        f"Provides foundational knowledge",
                        f"Offers practical applications",
                        f"Connects to broader concepts",
                        f"All of the above"
                    ],
                    "correct": 3
                }
